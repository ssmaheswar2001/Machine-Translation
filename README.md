...
In this project, we have built a character level language model for [transliterating](https://en.wikipedia.org/wiki/Transliteration) English text into Telugu. It is implemented using TensorFlow. 
Transliteration is the phonetic translation of the words in a source language ( here English ) into equivalent words in a target language ( here Telugu ). It preserves the pronunciation of the words.  
...
* **Dataset:** We have used [Kaggle](https://www.kaggle.com/datasets/warcoder/transliteration-dataset-21-indic-languages/data) dataset to train the model. Dataset is useful for transliteration tasks, the one we used contains 50,823 word transliteration pairs of English to Telugu.
* **Exploring the data:**
The data has been stored separately into two variables; source text and target text i.e. English and Telugu respectively
